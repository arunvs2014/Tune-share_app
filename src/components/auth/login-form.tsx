...
export default function LoginForm() {
  ...
  // In a real app, you'd use react-hook-form and handle submissions
  // with Firebase auth functions.
    ...
    <Card className="border-2 border-primary/20 shadow-xl">
      <CardHeader>
        ...
        <CardDescription className="font-body">
          {isSignUp ? 'Join the community to start sharing.' : 'Welcome back! Please sign in.'}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          {isSignUp && (
            <div className="space-y-2">
              ...
              <Input id="name" type="text" placeholder="Alex Melody" required />
            </div>
          )}
          <div className="space-y-2">
